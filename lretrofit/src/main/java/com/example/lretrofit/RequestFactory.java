...
public class RequestFactory {
    ...
    RequestFactory(@NonNull Builder builder) {
        ...
        mIsFormEncoded = builder.mIsFormEncoded;
        mParameterHandlers = builder.mParameterHandlers;
    }

    public okhttp3.Request create(@NonNull Object[] args) {
        int argumentCount = args.length;
        ParameterHandler<Object>[] handlers = (ParameterHandler<Object>[]) this.mParameterHandlers;
        ...
        return requestBuilder.get().tag(Invocation.class, new Invocation(mMethod, argumentList)).build();
    }
